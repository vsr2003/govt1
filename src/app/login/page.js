...
const Login = () => {
  ...
  return (
	<div class="min-h-screen flex items-center justify-center w-full ">
		<div class="bg-white border-y-[3px] border-blue-500  shadow-md rounded-lg px-8 py-6 max-w-md">
			...
			<form action="#">
				...
				<button type="submit" class="w-full my-1 flex justify-center py-2 px-4 border border-black rounded-md shadow-sm text-sm font-medium  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Login with SSO</button>
			</form>
